...
switch ($_GET["op"]) {
	...
	case 'listarp':
		...
		while($reg = $rspta->fetch_object()){
			$data[] = array(
				"0"=>'<button class="btn btn-warning" onclick="mostrar('.$reg->idpersona.')" data-toggle="modal" data-target="#myModal"><ion-icon name="create"></ion-icon></button>'.
				' <button class="btn btn-danger" onclick="eliminar('.$reg->idpersona.')" ><ion-icon name="trash"></ion-icon></button>',
				"1"=>$reg->nombre,
				"2"=>$reg->direccion,
