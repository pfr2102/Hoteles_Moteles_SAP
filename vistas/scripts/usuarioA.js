...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax":
				{
					url: '../ajax/usuario.php?op=listarFiltro',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function mostrar(idusuario){
	$.post("../ajax/usuario.php?op=mostrar",{idusuario : idusuario}, function(data, status)
	{
		...
		if($("#idusuarioActual").val() == $("#idusuario").val()){$('#rol').hide(); alert("hola");}//falta ver la manera que se oculte el combobox
 		$('#idhotelc').hide(); $('#idhotelc2').show();
