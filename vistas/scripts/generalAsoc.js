...
function tarifaOcupacion(){
	...
	$.post("../ajax/consultas.php?op=tarifaOcupacionAsoc",{fecha_inicio: fecha_inicio,fecha_fin: fecha_fin}, function(data, status){
...
function visitasEstados(fecha_inicio, fecha_fin){
	...
	$.post("../ajax/consultas.php?op=visitaEstadosAsoc",{fecha_inicio: fecha_inicio,fecha_fin: fecha_fin}, function(data, status){
		//alert(data);
		data = JSON.parse(data);
...
function Motivos(fecha_inicio, fecha_fin) {
  ...
  $.post("../ajax/consultas.php?op=motivoAsoc", {fecha_inicio: fecha_inicio,fecha_fin: fecha_fin}, function(data, status) {
    //alert(data);
    data = JSON.parse(data);
    // Acceder a las listas del objeto JSON
