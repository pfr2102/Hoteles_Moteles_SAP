              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Datos Generales de tu Hotel</h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        ...
                        <div class="form-group col-lg-2 col-md-4 col-sm-2 col-xs-12">
...
<script type="text/javascript" src="scripts/generalAsocEst.js"></script>
<?php 
}
ob_end_flush();
?>