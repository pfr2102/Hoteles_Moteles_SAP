...
}elseif($_SESSION['AccesoH']==0 or $_SESSION['AccesoH']!=1){
...
<!--Contenido-->
                    ...
                    <div class="panel-body"  id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <input type="hidden" name="rol" id="rol" value="CAPTURISTA">
 ...
 <?php 
  require 'footer.php';
 ?>   
 <script type="text/javascript" src="scripts/usuarioH.js"></script>
  <?php 
